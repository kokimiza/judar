...
extension Color {
    ...
    // Backgrounds
    static let rpgBackground = Color(uiColor: .init(dynamicProvider: { t in
    ...
    static let rpgSurface = Color(uiColor: .init(dynamicProvider: { t in
        t.userInterfaceStyle == .dark
    ...
    static let rpgGold = Color(uiColor: .init(dynamicProvider: { t in
        t.userInterfaceStyle == .dark
    ...
    static let rpgGoldDim = Color(uiColor: .init(dynamicProvider: { t in
        t.userInterfaceStyle == .dark
    ...
    static let rpgBorder = Color(uiColor: .init(dynamicProvider: { t in
        t.userInterfaceStyle == .dark
    ...
    // HP healthy
    static let rpgHealthy = Color(uiColor: .init(dynamicProvider: { t in
        t.userInterfaceStyle == .dark
    ...
    // Danger / low HP / error
    static let rpgDanger = Color(uiColor: .init(dynamicProvider: { t in
        t.userInterfaceStyle == .dark
...
extension EventType {
    var accentColor: Color {
        switch self {
        case .poop:       return Color(red: 0.95, green: 0.73, blue: 0.12)  // rich gold
        case .pee:        return Color(red: 0.20, green: 0.78, blue: 0.92)  // vibrant cyan
